...
6.  [x] [Intermediate CSS](#06-Intermediate-CSS)
7.  [x] [Bootstrap](#07-Bootstrap)
8.  [x] [Bootstrap 4](#08-Bootstrap-4)
9.  [x] [Bootstrap, Flexbox Layout](#09-Layout)
10. [x] [JavaScript Basics](#10-JavaScript-Basics)
11. [x] [JavaScript Control Flow](#11-JavaScript-Control-Flow)
    - [For Loops](./coursework/11-for-loops.html)
    - [While Loops](./coursework/11-while-loops.html)
12. [x] [JavaScript Functions](#12-JavaScript-Functions)
    - [Functions](./coursework/12-functions.html)
13. [x] [JavaScript Arrays](#13-JavaScript-Arrays)
    - [Arrays](./coursework/13-arrays.html)
14. [x] [JavaScript Objects](#14-JavaScript-Objects)
    - [MovieDB](./coursework/14-moviedb.html)
15. [x] [DOM Manipulation](#15-JavaScript-DOM)
    - [DOM Selectors](./coursework/15-dom-selectors.html)
16. [x] [JavaScript Events](#16-JavaScript-Events)
...
19. [x] [Advanced jQuery](#19-jQuery-Advanced)
20. [x] [Todo List Projects]()
21. [ ] [Patatap Clone]()
22. [x] [Backend Basics]()
23. [x] [The Command Line]()
24. [x] [Intro to NodeJS]()
25. [x] [Intro to Server Side Frameworks]()
26. [x] [Intermediate Express]()
27. [x] [Working with APIs]()
28. [x] [YelpCamp Basics]()
29. [x] [Databases]()
30. [x] [YelpCamp Data Persistence]()
31. [x] [RESTful Routing]()
32. [x] [Data Associations]()
33. [x] [YelpCamp Comments]()
34. [x] [Authentication]()
35. [x] [YelpCamp Authentication]()
36. [x] [YelpCamp Cleaning Up]()
37. [x] [YelpCamp Update and Destroy]()
38. [x] [YelpCamp UI Improvements]()
39. [x] [Git and Github]()
40. [x] [Deploying]()
41. [x] [JavaScript: The Tricky Stuff]()
